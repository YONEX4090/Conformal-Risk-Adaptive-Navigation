...
DATANAME = 'data_generation_DynamicUnicycle2D_mpc_cbf_6datapoint'
# DATANAME = 'data_generation_KinematicBicycle2D_mpc_cbf'
# 'gat_datagen_1_75_50000_KinematicBicycle2D_C3BF_mpc_cbf'
MODELNAME_SAVE = 'DynamicUnicycle2D_mpc_cbf_1'
SCALERNAME_SAVE = 'DynamicUnicycle2D_mpc_cbf_1'
...
if WANDB_FLAG:
    import wandb
    wandb.init(project="DynamicUnicycle2D_mpc_cbf_1", config={
        "learning_rate": LR,
        "epochs": EPOCH,
...
if __name__ == '__main__':
    ...
    if not USE_GAT_EMBED:
        ...
        if TEST_ONLY:
            ...
            y_pred_safety_loss = y_pred_safety_loss[0]
            ...
            train_dataX, train_dataY, test_dataX, test_dataY, scaler = load_and_preprocess_data(
                data_file, scaler_path, noise_percentage=1.0, robot_model=robot_model
            )
            ...
            for epoch in range(start_epoch, start_epoch + EPOCH):
                ...
                test_loss, bool_best, test_rmse, early_stop = penn.test(test_loader, epoch)
