...
class CrowdSimVarNum(CrowdSim):
    ...
    def reset(self, phase='train', test_case=None):
        ...
        # Handle case where thisSeed is None (set default to 0)
        seed_value = self.thisSeed if self.thisSeed is not None else 0
        self.rand_seed = counter_offset[phase] + self.case_counter[phase] + seed_value
